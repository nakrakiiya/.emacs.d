...
;; ## added by OPAM user-setup for emacs / tuareg ## b84293612dd71b522a77d21ba7e416f8 ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/home/xps13/.opam/system/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
